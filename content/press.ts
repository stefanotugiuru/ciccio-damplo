...
export const press: ArticoloPress[] = [
  {
    ...
    estratto: {
      it: "Dalla cucina di una nonna a undici ristoranti su cinque continenti: la storia di Francesco D'Amplo è la prova che, a Mineo, i sogni si fanno in pentola.",
      en: "From a grandmother's kitchen to eleven restaurants across five continents: Francesco D'Amplo's story proves that in Mineo, dreams are made in a pot.",
    },
    data: "2023-04-12",
    corpo: {
      it: [
